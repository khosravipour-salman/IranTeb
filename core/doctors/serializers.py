...
class DoctorDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = DoctorUser
        fields = ('full_name', 'doctor_specilist', 'rate', 'all_patients_reserved', 'experience_years',
                  'gender', 'city', 'registeration_date', 'adress', 'doctor_telephone', 'work_day', 'user_shifts')
...
class CancelSerializer(serializers.ModelSerializer):
    class Meta:
        model = Appointment
        fields = ('user_name', 'status_reservation',
                  'reservetion_code', 'patient_insurance')
